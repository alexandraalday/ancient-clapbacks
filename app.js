...
// randomly generate an integer between 0 and the array length of the quote library 
function randomQuote(){
   var random = Math.floor(Math.random()* (quotes.length) + 0);
   return "<p>" + quotes[random] + "</p>";
}

//push randomly selected quote from library to html call
